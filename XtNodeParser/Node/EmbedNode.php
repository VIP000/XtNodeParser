...
class EmbedNode extends Node implements \XtNodeParser\Implement\Node
{
    ...
    public function __toString()
    {
        ...
        return \sprintf(
                '<iframe width="360" height="300" src="%s" frameborder="0" allowfullscreen></iframe>', $mXmlAttr['url']);
    }
